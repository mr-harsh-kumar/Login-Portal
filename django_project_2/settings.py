...
SECRET_KEY = 'django-insecure-kk@7&b5nhg2pzp1$dn^@f2uqk@(r@*+ws0a@3$u2s$(lx+7&9d'
...
# Add the directories where static files are located
...
# settings.py
SESSION_COOKIE_AGE = 86400  # Set session expiration time to 1 day (in seconds)
